...
def main():
    ...
    st.markdown("""
    <style>
        /* הפיכת ה-container הראשון ל-sticky */
        div[data-testid="stMainBlockContainer"] > div > div:first-child {
        ...
        div[data-testid="stMainBlockContainer"] > div > div:first-child img {
        ...
        /* צמצום רווחים בשורה העליונה */
        div[data-testid="stMainBlockContainer"] > div > div:first-child [data-testid="column"] {
            padding: 0 !important;
        }
    </style>
    """, unsafe_allow_html=True)
